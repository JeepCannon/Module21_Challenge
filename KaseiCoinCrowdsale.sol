...
contract KaseiCoinCrowdsale { // UPDATE THE CONTRACT SIGNATURE TO ADD INHERITANCE
    ...
    constructor() public Crowdsale(rate, wallet, token) {
...
contract KaseiCoinCrowdsaleDeployer {
    ...
    // Add the constructor.
    constructor(string memory name, string memory symbol, address payable wallet, uint256 rate, uint256 inital_supply)
       public {
        // Create a new instance of the KaseiCoin contract.
        KaseiCoin token = new KaseiCoin(name, symbol, inital_supply);
